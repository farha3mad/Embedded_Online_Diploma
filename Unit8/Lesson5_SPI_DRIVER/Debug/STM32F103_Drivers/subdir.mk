...
./STM32F103_Drivers/STM32F103C6_SPI_DRIVER.d \
...
STM32F103_Drivers/STM32F103C6_SPI_DRIVER.o: ../STM32F103_Drivers/STM32F103C6_SPI_DRIVER.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -g3 -DSTM32 -DSTM32F1 -DSTM32F103C6Tx -DDEBUG -c -I../Inc -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"STM32F103_Drivers/STM32F103C6_SPI_DRIVER.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
